...
<Window x:Class="vmimages.MainWindow"
        ...
        mc:Ignorable="d"
        Title="VM provisioner" Height="479.919" Width="704.406" ResizeMode="NoResize">
    <Grid Margin="0,0,2,0">
        ...
        <TextBox x:Name="textBoxGateway" Text="" HorizontalAlignment="Left" Height="23" Margin="356,71,0,0" VerticalAlignment="Top" Width="100" TabIndex="9"/>
        <TextBox x:Name="textBoxDNS1" Text="" HorizontalAlignment="Left" Height="23" Margin="356,99,0,0" VerticalAlignment="Top" Width="100" TabIndex="11"/>
        ...
        <TextBox x:Name="textBoxNetmask" Text="" HorizontalAlignment="Left" Height="23" Margin="558,44,0,0" VerticalAlignment="Top" Width="100" TabIndex="8"/>
        ...
        <TextBox x:Name="textBoxDNS2" Text="" HorizontalAlignment="Left" Height="23" Margin="558,99,0,0" VerticalAlignment="Top" Width="100" TabIndex="12"/>
...
$ESXHost = "aptxvcenterlab1.ptx.axway.int";
...
$STEdgePath = "/root/edge/SecureTransport/conf/"
...
$Timeout = 900
$VersionString = "1.3 August 2019"

# List of ESX Server Hostnames
$vSphereClusters = New-Object System.Collections.ArrayList;
$vSphereClusters.AddRange(("enoidsh11.lab.noid.axway.int","enoidsh12.lab.noid.axway.int","enoidsh13.lab.noid.axway.int","enoidsh14.lab.noid.axway.int","enoidsh8.lab.noid.axway.int"));
...
$STVersionsArray.AddRange(("533","536","540","521","530"));
...
$STOSArray.AddRange(("SUSE12","RHEL76","WIN2K8","WIN2K12"));

# List of CG supported versions. Use string that follows the naming convention of the templates.
$CGVersionsArray = New-Object System.Collections.ArrayList;
$CGVersionsArray.AddRange(("113","I am dummy dont choose me !!"));

# List of CG supported OSes. Use string that follows the naming convention of the templates.
$CGOSArray = New-Object System.Collections.ArrayList;
$CGOSArray.AddRange(("CENTOS7","I am dummy Os dont choose me !!"));

#List of CFT supported version .Use string that follows the naming convention of the templates.
$CFTVersionsArray = New-Object System.Collections.ArrayList;
$CFTVersionsArray.AddRange(("324","332","340"));
...
$APIVersionsArray = New-Object System.Collections.ArrayList;
$APIVersionsArray.AddRange(("ALL","NULL"));

#List of API Suite supported OSes.Use string that follows the naming convention of the templates.
$APIOSArray = New-Object System.Collections.ArrayList;
$APIOSArray.AddRange(("NULL","RHEL7"));
...
$EngineersArray.AddRange(("Arpit","Seth","Surya","Nishant","Akil","Shivangi","Tapan","Nidhi","Mohit","Vatsalya","chirag","abhinav","Sharjil","raju","sandeep","rahul","praveen","Nitasha","Nikhil","Jyoti"));
...
Function Create-TemplateName 
{
	...
	ElseIf (($WPFcomboBoxProduct.SelectedItem -eq "CFT"))
	{
		$TemplateConstructedName=$TemplateConstructedName + "CFT";
	}
	ElseIf (($WPFcomboBoxProduct.SelectedItem -eq "API"))
	{
		$TemplateConstructedName=$TemplateConstructedName + "API";
	}
...
Function Create-OSCustomizationDetails
{
	...
	#to make hostname diffrent each time.
	$HostNamePrefix = $HostNamePrefix + $spaceme + $WPFtextBoxName.Text;
...
$WPFcomboBoxProduct.Add_SelectionChanged({
	...
	{
		# Filling the OS and Version ComboBoxes.
		$WPFcomboBoxVersion.ItemsSource = $CFTVersionsArray;
		$WPFcomboBoxOS.ItemsSource = $CFTOSArray;
	...
	{
		# Filling the OS and Version ComboBoxes.
		$WPFcomboBoxVersion.ItemsSource = $APIVersionsArray;
		$WPFcomboBoxOS.ItemsSource = $APIOSArray;
